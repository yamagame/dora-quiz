...
class App extends Component {
  ...
  render() {
    const bgStyle = {};
    if ("backgroundImage" in this.props && this.props.backgroundImage != null)
      bgStyle.backgroundImage = `url(${this.props.backgroundImage})`;
    if ("backgroundColor" in this.props && this.props.backgroundColor != null)
      bgStyle.backgroundColor = this.props.backgroundColor;
    return (
      <div
        style={{
          height: "100%",
